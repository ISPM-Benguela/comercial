					...
					<div class="right-top-bar flex-w h-full">
					   @guest
						...
						@else 
							...
							@else 
							  <a href="{{route('cliente')}}" class="flex-c-m trans-04 p-lr-25">
								pagina cliente
							  </a>
							@endrole
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop" >
						<ul class="main-menu">
                            ...
                            <li>
									<a href="{{ route('encomendar.index')}}">Encomedar</a>
							</li>
							<li>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="{{ $total }}">
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{asset('images/produto1/product01.png')}}" alt="IMG">
						</div>

						<div class="header-cart-item-txt p-t-8">
							<a href="#" class="header-cart-item-name m-b-18 hov-cl1 trans-04">
								Todos produtos no carrinho
							</a>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Qualquer duvida? entre em contacto com a nossa equepa de vendas ligando para (+244) 926 716 687
					</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todo direito reservado.</a>
